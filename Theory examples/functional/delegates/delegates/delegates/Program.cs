...
namespace TPP.Functional.Delegates {
    ...
    class Program {
        ...
        /// </summary>
        private delegate int Function(int integer); //delegate is a type

        /// <summary>
        /// Function (static, class, method) that returns twice the value 
        /// of the parameter passed
        /// </summary>
        private static int Twice(int a) { return a + a; } //Has same type as funtion (returns an int, receives an int)

        /// <summary>
        /// Higher-order function (receives a function and an integer)
        ...
        private static int DoubleApplication(Function function, int integer) { 
            return function(function(integer)); //First evaluated is integer, then function(integer), then function(function(integer))
        }
        ...
        static void Main() {
            ...
            Algorithms.Comparison comparison; //comparison is a variable of Type: Algorithms.Comparison
